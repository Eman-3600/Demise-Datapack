...
tellraw @s[tag=!KnowsCorporeal] {"text":"The nether star's power allows you to fully materialize. While it is in your possession, you cannot enter ethereal form, but you can process food and don't burn in daylight.","color":"dark_purple"}
